...
"[project]/app/api/chits/branches/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const branchesData = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].chit.findMany({
            select: {
                state: true,
                branch: true,
                location: true
        ...
        const branchesWithCount = await Promise.all(branchesData.map(async (item)=>{
            const count = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].chit.count({
                where: {
                    state: item.state,
                    branch: item.branch
                }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__49ed5e8c._.js.map