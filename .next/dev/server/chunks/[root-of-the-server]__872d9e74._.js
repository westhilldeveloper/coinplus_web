...
"[project]/app/api/chits/create/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        if (body.chit_value <= 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: 'Chit value must be positive'
            }, {
                status: 400
            });
        }
        // Create chit
        const chit = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].chit.create({
            data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__872d9e74._.js.map