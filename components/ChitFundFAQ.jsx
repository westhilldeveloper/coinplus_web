                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-6 sm:gap-8 md:gap-10">
                      <div className="lg:w-2/3">
                        <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                          <div className="relative">
                            <div className="p-2.5 sm:p-3 md:p-4 bg-gradient-to-br from-red-600 to-orange-500 rounded-lg sm:rounded-xl md:rounded-2xl shadow-lg sm:shadow-xl">
                              <Youtube className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 text-white" />
                            </div>
                          </div>
                          <div className="min-w-0">
                            <h3 className="font-bold text-lg sm:text-xl md:text-2xl lg:text-3xl text-gray-800 truncate">
                              YouTube Learning Hub
                            </h3>
                            <p className="text-gray-600 text-sm sm:text-base truncate">
                              Master financial concepts with video tutorials
                            </p>
                          </div>
                        </div>
                        
                        <p className="text-gray-700 mb-4 sm:mb-6 md:mb-8 text-sm sm:text-base md:text-lg leading-relaxed">
                          Dive deep into our exclusive video library covering everything from basic chit fund concepts 
                          to advanced investment strategies and financial planning.
                        </p>
                        ...
                        <div className="flex flex-col xs:flex-row flex-wrap gap-3 sm:gap-4">
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="group relative px-4 py-2.5 sm:px-6 sm:py-3 md:px-8 md:py-4 bg-gradient-to-r from-red-600 to-red-700 text-white font-bold rounded-lg sm:rounded-xl hover:shadow-lg sm:hover:shadow-xl hover:shadow-red-500/20 transition-all duration-300 active:scale-95 sm:hover:scale-105 text-sm sm:text-base md:text-lg flex-1 min-w-[140px]"
                          >
                            <div className="absolute inset-0 bg-gradient-to-r from-red-500 to-pink-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-lg sm:rounded-xl" />
                            <span className="relative flex items-center justify-center gap-2 sm:gap-3">
                              <Youtube className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6" />
                              <span className="truncate">Explore Channel</span>
                            </span>
                          </a>
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="group relative px-4 py-2.5 sm:px-6 sm:py-3 md:px-8 md:py-4 bg-gradient-to-r from-gray-800 to-black text-white font-bold rounded-lg sm:rounded-xl hover:shadow-lg sm:hover:shadow-xl hover:shadow-black/20 transition-all duration-300 active:scale-95 sm:hover:scale-105 text-sm sm:text-base md:text-lg flex-1 min-w-[140px]"
                          >
                            <div className="absolute inset-0 bg-gradient-to-r from-gray-700 to-gray-900 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-lg sm:rounded-xl" />
                            <span className="relative flex items-center justify-center gap-2 sm:gap-3">
                      ...
                      {/* Latest Video Preview - Responsive sizing */}
                      <div className="lg:w-1/3 w-full mt-6 lg:mt-0">
                        <div className="relative group">
                          {videos.length > 0 ? (
                            ...
                            >
                              <div className="relative overflow-hidden rounded-lg sm:rounded-xl md:rounded-2xl shadow-lg sm:shadow-xl transform transition-all duration-500 group-hover:scale-100 sm:group-hover:scale-105">
                                <div className="aspect-video">
                                  <YouTubePlayer 
                                ...
                                <div className="absolute bottom-0 left-0 right-0 p-3 sm:p-4 md:p-6">
                                  <div className="flex items-center gap-2 mb-1 sm:mb-2">
                                    <div className="p-1 sm:p-2 bg-red-600 rounded-md sm:rounded-lg">
                                      <Play className="w-3 h-3 sm:w-4 sm:h-4 text-white" />
                                    </div>
                                    <span className="text-white font-bold text-xs sm:text-sm">LATEST RELEASE</span>
                                  </div>
                            ...
                            <div className="relative aspect-video bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg sm:rounded-xl md:rounded-2xl flex items-center justify-center border border-gray-300">
                              <div className="text-center p-4">
                                <div className="animate-spin rounded-full h-8 w-8 sm:h-10 sm:w-10 md:h-12 md:w-12 border-b-2 border-red-600 mx-auto mb-3 sm:mb-4" />
                                <p className="text-gray-600 text-sm sm:text-base">Loading latest video...</p>
                              </div>
                            </div>
                          )}
                        </div>
